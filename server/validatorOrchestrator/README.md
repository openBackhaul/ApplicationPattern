...
This Validator Orchestrator shall be included as a module to your application that can,
...
Prepare the input data. Either using option 1 or option 2 the orchestrator shall be run.
