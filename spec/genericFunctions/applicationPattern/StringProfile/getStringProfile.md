...
### Description  
core-model-1-4:control-construct/profile-collection holds all the profiles. To retrieve a **StringProfile object for given UUID**  this function shall be used.
